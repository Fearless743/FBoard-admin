  ...
  "server": {
    ...
    "columns": {
      ...
      "actions_dropdown": {
        ...
        "upgrade": {
          "title": "Подтверждение обновления автономной службы",
          "description": "Будет обновлён весь процесс Fboard-Node этого автономного узла, а не отдельный протокольный узел.",
          "standalone": "Обновить автономный Fboard-Node",
          "standalone_title": "Подтверждение обновления автономного Fboard-Node",
          "standalone_description": "Будет обновлён весь процесс Fboard-Node автономного узла, а не отдельный протокольный узел. Служба может быть кратковременно недоступна.",
          "confirm": "Обновить"
        },
        "upgrade_success": "Задача обновления отправлена",
        "restart": {
          "menu": "Перезапустить службу",
          "standalone_menu": "Перезапустить службу автономного Fboard-Node",
          "title": "Подтверждение перезапуска службы",
          "standalone_description": "Будет перезапущен весь процесс Fboard-Node этого автономного узла, что вызовет кратковременное прерывание его работы.",
          "machine_description": "Перезапуск машины доступен в разделе управления серверами и затрагивает все размещённые на ней узлы.",
          "confirm": "Перезапустить",
          "submitted": "Задача перезапуска отправлена",
          "error": "Не удалось отправить задачу перезапуска"
        },
        "machine_manage": "Открыть управление серверами",
