  ...
  "server": {
    ...
    "columns": {
      ...
      "onlineUsers": {
        ...
        "sort_tip": "Сортировать по количеству пользователей онлайн"
      },
      "rate": {
        "title": "Множитель",
    ...
    "form": {
      ...
      "routes": {
        ...
        "hint": "Необязательно; привязанные правила маршрутизации передаются в подписку клиентов этого узла"
      },
      "machine": {
  ...
  "coupon": {
    ...
    "table": {
      ...
      "actions": {
        ...
        "dropUsedUp": "Удалить исчерпанные",
        "dropUsedUpConfirm": {
          "title": "Удаление исчерпанных купонов",
          "description": "Вы уверены, что хотите удалить все купоны с нулевым остатком использований? Это действие нельзя отменить."
        },
        "dropUsedUpResult": {
