  ...
  "server": {
    ...
    "form": {
      ...
      "port": {
        ...
        "placeholder": "443 или 10000-40000",
        "tooltip": "Порт подключения клиента. Поддерживается один порт (например 443) или диапазон (например 10000-40000). При использовании транзита/туннеля может отличаться от порта сервера.",
